    ...
    <footer class="bg-background-secondary">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          ...
          <li>
            <a href="https://github.com/arifpavel" target="_blank" class="hover:text-red-400">
          ...
          <li>
            <a href="https://twitter.com/arifpavel8" target="_blank" class="hover:text-red-400">
          ...
          <li>
            <a href="https://instagram.com/pavel.arif" target="_blank" class="hover:text-red-400">
