<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-8 border-red-700 ">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        <div class="block lg:hidden">
          <button @click="toggle" class="flex items-center px-3 py-2 border rounded border-teal-500 hover:text-teal-600 hover:border-teal-600" data-cypress="hamburger">
            <svg class="current-color h-3 w-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z" fill="teal" /></svg>
          </button>
        </div>
        <ul
        ...
        >
          ...
          <li>
            <a v-if="$route.path === '/'" href="/#projects" v-scroll-to="'#projects'" class="text-copy-primary hover:text-teal-600" data-cypress="projects">Projects</a>
            <g-link v-else to="/#projects" class="text-copy-primary hover:text-teal-600">Projects</g-link>
          </li>
          <li>
            <a v-if="$route.path === '/'" href="/#about" v-scroll-to="'#about'" class="text-copy-primary hover:text-teal-600" data-cypress="about">About</a>
            <g-link v-else to="/#about" class="text-copy-primary hover:text-teal-600">About</g-link>
          </li>
          <li>
            <a v-if="$route.path === '/'" href="/#contact" v-scroll-to="'#contact'" class="text-copy-primary hover:text-teal-600" data-cypress="contact">Contact</a>
            <g-link v-else to="/#contact" class="text-copy-primary hover:text-teal-600">Contact</g-link>
          </li>
          <li>
            <g-link to="/docs" class="text-copy-primary hover:text-teal-600" data-cypress="docs">Docs</g-link>
          </li>
          <li>
            <g-link to="/blog" class="text-copy-primary hover:text-teal-600" data-cypress="blog">Blog</g-link>
          </li>
        </ul>
      </nav>
    </header>
    ...
    <footer class="bg-background-secondary">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          ...
          <div>
            <a href="/rss.xml" class=" hover:text-red-400 font-normal">RSS Feed</a> |
            <a href="/sitemap.xml" class="hover:text-red-400 font-normal">Sitemap</a>
          </div>
        </div>
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:pavelpatiya@gmail.com" class="hover:text-red-400">
          ...
          <li>
            <a href="https://youtube.com/drehimself" target="_blank" class="hover:text-red-400">
          ...
          <li>
            <a href="https://github.com/drehimself/gridsome-portfolio-starter" target="_blank" class="hover:text-red-400">
          ...
          <li>
            <a href="https://twitter.com/drehimself" target="_blank" class="hover:text-red-400">
          ...
          <li>
            <a href="https://instagram.com" target="_blank" class="hover:text-red-400">
